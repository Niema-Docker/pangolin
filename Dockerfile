...
RUN apk update && \
    ...
    pip install --no-cache-dir 'biopython==1.74' 'pandas==1.0.1' 'git+https://github.com/cov-lineages/pangoLEARN.git' 'git+https://github.com/cov-lineages/scorpio.git' 'git+https://github.com/cov-lineages/constellations.git' 'git+https://github.com/cov-lineages/pango-designation.git' && \
